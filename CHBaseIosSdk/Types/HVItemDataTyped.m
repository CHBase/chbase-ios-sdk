...
+(void) initialize
{
    ...
    [s_typeRegistry addClass:[HVAppointment class] forTypeID:[HVAppointment typeID]];
    ...
    [s_typeRegistry addClass:[HVAppSpecificInformation class] forTypeID:[HVAppSpecificInformation typeID]];
    [s_typeRegistry addClass:[HVMedicationFill class] forTypeID:[HVMedicationFill typeID]];
    [s_typeRegistry addClass:[HVAsthmaInhaler class] forTypeID:[HVAsthmaInhaler typeID]];
    [s_typeRegistry addClass:[HVAsthmaInhalerUsage class] forTypeID:[HVAsthmaInhalerUsage typeID]];
    [s_typeRegistry addClass:[HVInsulinInjectionUsage class] forTypeID:[HVInsulinInjectionUsage typeID]];
    [s_typeRegistry addClass:[HVInsulinInjection class] forTypeID:[HVInsulinInjection typeID]];
    ...
    [s_typeRegistry addClass:[HVMessage class] forTypeID:[HVMessage typeID]];
    [s_typeRegistry addClass:[HVLabTestResults class] forTypeID:[HVLabTestResults typeID]];
